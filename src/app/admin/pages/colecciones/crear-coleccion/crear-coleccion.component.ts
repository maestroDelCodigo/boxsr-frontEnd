...
export class CrearColeccionComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    coleccion.precio_rebajado = !this.f.precio_rebajado.value
      ? 0
      : this.f.precio_rebajado.value;
    ...
    coleccion.descripcion_resumen = this.f.resumen.value;
        ...
        .subscribe((resultado) => {
          if (resultado) {
            this.messageService.add({
              severity: 'success',
              summary: 'Coleccion',
              detail: 'Coleccion creada correctamente.',
            });
